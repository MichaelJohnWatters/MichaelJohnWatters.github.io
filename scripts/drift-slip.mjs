...
for(let s=0;s<10;s++){ await new Promise(r=>setTimeout(r,250)); console.log('  ', await read()) }
await page.keyboard.up('KeyD')
console.log('  -- lift steer (should recover) --')
for(let s=0;s<3;s++){ await new Promise(r=>setTimeout(r,250)); console.log('  ', await read()) }
